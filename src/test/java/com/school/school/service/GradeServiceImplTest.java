...
class GradeServiceImplTest {
    ...
    @Test
    void createGradesBulkNonTransactional_shouldReturnCreatedGradesAndClearCacheOnFullSuccess() {
        GradeRequest firstRequest = new GradeRequest(8, LocalDate.now(), 1L, 10L);
        GradeRequest secondRequest = new GradeRequest(9, LocalDate.now(), 2L, 11L);
        ...
        List<GradeResponse> actual = gradeService.createGradesBulkNonTransactional(List.of(firstRequest, secondRequest));
